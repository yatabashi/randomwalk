...
# 設定
init_positions = [(30, 30), (-30, 30), (-30, -30), (30, -30)] # 亀の初期位置として、2つの実数（x軸の値、y軸の値）からなるタプルの配列を入力。相互回避が成立するためには、任意の2つのタプルの第n要素について、その差がstepの整数倍である必要がある（n=0,1）。
step = 10 # 亀の歩幅。0より大きい実数を入力

# 変数定義
turtles = []
is_alive = []
num_of_turtles = len(init_positions)
